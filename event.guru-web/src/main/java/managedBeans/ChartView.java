...
Client client = ClientBuilder.newClient();
		...
		WebTarget target = client.target("http://localhost:4640/api/StatusTicket");
		...
		List<String> myList = new ArrayList<String>(Arrays.asList(result1.split(",")));
        ...
        boys.setLabel("");
        boys.set("2016",Double.parseDouble(myList.get(0)) );
        boys.set("2017",Double.parseDouble(myList.get(1)) );
        boys.set("2018",Double.parseDouble(myList.get(2)) );
        boys.set("2019",Double.parseDouble(myList.get(3)) );
    ...
    private void createLineModels() {
        ...
        lineModel2.setTitle("Amount per year");
...
Client client = ClientBuilder.newClient();
		...
		WebTarget target = client.target("http://localhost:4640/api/SeatCon");
		...
		//barModel.set("", Double.parseDouble(myList.get(0)));
	//	barModel.set("", Double.parseDouble(myList.get(1)));
 
        ChartSeries boys = new ChartSeries();
        boys.setLabel("vip");
        boys.set("", Double.parseDouble(myList.get(0)));
 
        ChartSeries girls = new ChartSeries();
        girls.setLabel("normal");
        girls.set("", Double.parseDouble(myList.get(1)));
    ...
    private void createBarModel() {
        ...
        barModel.setTitle("prix Ticket by year");
        barModel.setLegendPosition("ne");
 
        Axis xAxis = barModel.getAxis(AxisType.X);
        xAxis.setLabel("Amont");
...
Client client = ClientBuilder.newClient();
		...
		WebTarget target = client.target("http://localhost:4640/api/TypeTicket");
        ...
        pieModel1.set("vip", Integer.parseInt(myList.get(0)));
        pieModel1.set("normal", Integer.parseInt(myList.get(1)));
        
 
      
		
 
        pieModel1.setTitle("TypeTicketPie Pie");
...
Client client = ClientBuilder.newClient();
		...
		WebTarget target = client.target("http://localhost:4640/api/TypeSeat");
        ...
        pieModel2.set("sold", Integer.parseInt(myList.get(0)));
        pieModel2.set("unsold", Integer.parseInt(myList.get(1)));
        
        
 
        pieModel2.setTitle("TypeSeatPie Pie");
